...
public class User implements Serializable {
    ...
    public User(JSONObject json) throws JSONException {
        ...
        this.age_group_name = json.getString("age_group_name");
        this.age_group_id = json.getString("age_group_id");
        this.mood_name = json.getString("mood_name");
        this.mood_imgUrl = json.getString("mood_imgUrl");
        this.mood_id = json.getString("mood_id");
