...
public class WordBSTDictionaryTest {
    ...
    public void testOrders3() {
        ...
        //how exactly do expect me to write this?! I haven't the slightest idea what the end result is.
        //TODO List the pre-order of the binary-search tree built by keys
        String preorderedkeys[] = {"a", "b", "c", "d", "e", "f"};
        ...
        String postorderedkeys[] = {"a", "b", "c", "d", "e", "f"};
        Integer val = 1;
        for (String key: keys)
            dict.set(key, val);
